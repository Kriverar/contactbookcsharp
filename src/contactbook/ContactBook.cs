...
public class ContactBook
{
    ...
    {
        Console.WriteLine("Welcome to Kristian's Contact Book!");
        PressEnterContinue();
    }
    ...
    {
        Console.Clear();
        Console.WriteLine("Thank you for using Kristian's Contact Book!");
    }
    ...
    private void DeduplicateContacts()
    {
        ...
        foreach (var group in duplicateGroups)
        {
            if (group.Count > 1)
            {
                ...
                List<Contact> mergedLS = new List<Contact>();
                mergedLS.Add(merged);
                ...
                {
                    temp.Add(merged);
                    Console.WriteLine("Operation successful: Contacts merged.");
                }
                else
                {
                    temp.AddRange(group);
        ...
        if (Confirm("Do you want to apply all merges to the contact list?", NO))
        {
            allContacts = temp;
            filteredContacts = allContacts;
            page = 1;

            Console.WriteLine("Operation successful: Contacts deduplicated.");
        }
        else
        {
